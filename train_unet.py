...
weights_path = "/home/jovyan/deep-unet-for-satellite-image-segmentation/weights"
...
if __name__ == '__main__':     
    ...
    for img_id in trainIds:
        ...
        img_m = normalize(tiff.imread('/home/jovyan/data/train/RGB-PanSharpen/{}'.format(img_id)))
        mask = np.array([tiff.imread('/home/jovyan/data/train/Masks/buildings_{}'.format(img_id[15:]))/ 255]).transpose([1, 2, 0])
